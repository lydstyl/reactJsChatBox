...
class App extends React.Component{
    ...
    componentWillMount(){ // juste avant que le component soit monté
        this.ref = base.syncState('/', { // on pourrait faire /messages
            context: this,
            state: 'messages'
        });
    }
    componentDidUpdate(){// dès qu'il y a une mise à jour tu scroll vers le bas
